...
declare module "vue-router" {
  interface RouteMeta {
    title?: string
    /**
     * 本地 SVG 图标名（assets/icons/*.svg 的文件名），优先级最高。
     * 与 icon 同时设置时，svgIcon 优先生效。
     */
    svgIcon?: SvgName
    /**
     * 通用图标标识，由 AppIcon 组件统一渲染，支持三种格式：
     * - `svg:name`              → 本地 SvgIcon
     * - `mdi:home` / `ep:user` → Iconify 图标（集合名:图标名）
     * - `HomeFilled`            → Element Plus 图标组件名
     */
    icon?: string
    /**
    ...
    keepAlive?: boolean
    /**
     * @description 标记该路由为接口动态生成，用于 resetRouter 时识别并移除
     */
    dynamic?: boolean
  }
}
