import type { VxeGlobalThemeName } from "vxe-table"
import { setCssVar } from "@@/utils/css"
import { getActiveThemeName, setActiveThemeName } from "@@/utils/local-storage"
import { VxeUI } from "vxe-table"

/** 将自定义主题名映射到 Vxe 支持的主题名 */
function toVxeTheme(name: ThemeName): VxeGlobalThemeName {
...
export type ThemeName = DefaultThemeName | "dark" | "classic"
...
const themeList: ThemeList[] = [
  {
    titleKey: "themeSwitch.light",
    name: DEFAULT_THEME_NAME
  },
  {
    titleKey: "themeSwitch.dark",
    name: "dark"
  },
  {
    titleKey: "themeSwitch.classic",
    name: "classic"
  }
]
...
function setTheme({ clientX, clientY }: MouseEvent, value: ThemeName) {
  ...
  VxeUI.setTheme(toVxeTheme(value))
}
